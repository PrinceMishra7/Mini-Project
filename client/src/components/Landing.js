...
const Landing = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-8xl mb-4 font-bold text-lg text-green-500">CryptoFunder
        <br class="hidden lg:inline-block"/> 
      </h1>
      <h1 class="title-font sm:text-2xl text-2xl mb-4  text-gray-600">CryptoFunder
      Empowering the Future of Crowdfunding with Blockchain Technology.
      </h1>
      <p class="mb-8 leading-relaxed">Join our blockchain-based crowdfunding platform and be a part of the decentralized future of fundraising.Experience the power of blockchain technology and take your fundraising to the next level with our decentralized crowdfunding platform.</p>
