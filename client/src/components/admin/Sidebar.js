      ...
      <div class="flex flex-col justify-between flex-1 mt-2">
        <nav>
          <a
            ...
            class={
              active === "1"
                ? "flex items-center px-4 py-2 mt-5 text-black bg-white rounded-md "
                : "flex items-center px-4 py-2 mt-5 text-white transition-colors duration-300 transform rounded-md  hover:bg-gray-100 hover:text-gray-700"
            }
          >
            <svg
              class="w-5 h-5"
